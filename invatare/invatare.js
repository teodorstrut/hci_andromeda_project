...
function TestSound() {
    ...
    var startSound = new Audio("../Audio/Salut! Astazi vom invata despre spatiul cosmic.m4a")
    startSound.play();
    ...
    var galaxiaSound = new Audio("../Audio/Ne aflam in galaxia 'Calea Lactee'..m4a");
    ...
    var planeteSound = new Audio("../Audio/Sistemul solar este format din Soare si 8 planete.m4a");
    ...
    var sunSound = new Audio("../Audio/In galaxia noastra se afla foarte multe stele. Cea.m4a");
    ...
    var mercurSound = new Audio("../Audio/Mercur este cea mai apropiata planeta de Soare.m4a");
    ...
    var venusSound = new Audio("../Audio/Venus este cea mai fierbinte planeta din sistemul.m4a");
    ...
    var terraSound = new Audio("../Audio/Pamantul este planeta pe care locuim. Se mai numes.m4a");
    ...
    var lunaSound = new Audio("../Audio/Luna este satelitul natural al Pamantului.m4a");
    ...
    var marteSound = new Audio("../Audio/Marte este denumita si Planeta Rosie.m4a");
    ...
    var jupiterSound = new Audio("../Audio/Jupiter este cea mai mare planeta.m4a");
    ...
    var uranusSound = new Audio("../Audio/Uranus este cea mai rece planeta.m4a");
    ...
    var neptunSound = new Audio("../Audio/Neptun este cea mai departata planeta fata de Soar.m4a");
    ...
    var infoSpaceSound = new Audio("../Audio/partea 2/mai contine asteroizi,.m4a");
    ...
    var asteroiziSound = new Audio("../Audio/partea 2/cel mai mare asteroid.m4a");
